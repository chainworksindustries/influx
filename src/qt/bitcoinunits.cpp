...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("INFX");
    case mBTC: return QString("mINFX");
    case uBTC: return QString::fromUtf8("μINFX");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Influxs"));
    case mBTC: return QString(QObject::tr("Milli-Influxs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Influxs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
