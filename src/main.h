...
static const int FORK_HEIGHT = 15000; // 2 days min, 30 days max, block reward reduction, 4 min block times, 8% apr
...
static const int64_t MIN_TXOUT_AMOUNT = 0;
...
static const uint256 hashGenesisBlock("0x00000cbd79dc030b9a4397f20a6607fcbd41a05a6ffdd6f8167c73c7123f18bb");
static const uint256 hashGenesisBlockTestNet("0x0000a3702fcced20983244e54290842fc199faf457863913ef7e631b6732a8d3");

inline int64_t PastDrift(int64_t nTime)   { return nTime - 70 * 60; } // up to 70 minutes from the past
inline int64_t FutureDrift(int64_t nTime) { return nTime + 70 * 60; } // up to 70 minutes from the future
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, unsigned int nBits, int64_t nTime, bool bCoinYearOnly=false, int64_t nFees=0);
...
public:
    ...
    {
        // Protocol switch to support p2pool at Influx block #0
        ...
        // Before Influx block #0 - get from pregenerated table
